...
export function CTA({
  ...
  return (
    <section className="bg-[#1a3048] px-4 py-16 sm:py-20 md:px-12 md:py-24">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-8 text-center">
        ...
        <div className="w-full max-w-2xl rounded-3xl bg-white p-4 shadow-[0_22px_60px_rgba(0,0,0,0.25)]">
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <button
              ...
              className="h-12 whitespace-nowrap rounded-xl bg-[#132435] px-6 text-sm font-extrabold text-white transition hover:bg-[#1a3048] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-100 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
            >
              Find resources
            </button>
          </div>
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={onIntro}
            className="h-12 rounded-full bg-teal-600 px-8 text-sm font-extrabold text-white transition hover:bg-teal-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/30 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a3048]"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 pt-2 text-sm font-semibold text-teal-200/80">
          {["Free to use", "No account needed to search", "Privacy protected"].map((t) => (
